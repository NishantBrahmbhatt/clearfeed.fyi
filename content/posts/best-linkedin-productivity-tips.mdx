...
[MyFeedIn](https://myfeedin.co?atp=PO9qAX) replaces the main feed with a custom feed of specific people you choose. Open LinkedIn, see posts from your curated list, engage with the relevant ones, then close the tab. The session has a natural end point because there's nothing else to scroll into.
...
The most productive LinkedIn routine combines three things: a custom feed of specific people to engage with daily using a tool like [MyFeedIn](https://myfeedin.co?atp=PO9qAX), a consistent posting schedule of two to three times per week, and hard time limits on every LinkedIn session.
