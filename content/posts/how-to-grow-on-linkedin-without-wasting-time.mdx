...
The fastest path to LinkedIn growth combines consistent posting two to three times per week with daily targeted commenting on posts from people in your niche. Commenting on posts from accounts with large followings gets your name in front of their audience organically. A custom feed tool like [MyFeedIn](https://myfeedin.co?atp=clearfeed) makes targeted daily commenting practical by removing the need to scroll the main feed.
