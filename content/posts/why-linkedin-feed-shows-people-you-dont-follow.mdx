...
The most effective solution is to replace LinkedIn's main feed with a custom feed of specific people you choose using [MyFeedIn](https://myfeedin.co?atp=clearfeed). You can also unfollow connections whose posts you do not want to see without disconnecting from them, which reduces the algorithm's surface area over time.
...
Yes. The most effective method is [MyFeedIn](https://myfeedin.co?atp=clearfeed), a Chrome extension that lets you create custom feeds of specific LinkedIn users. You choose exactly who appears in your feed.
